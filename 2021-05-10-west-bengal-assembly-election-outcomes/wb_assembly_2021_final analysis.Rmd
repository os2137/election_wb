...
theme_update(
  ...
  text = element_text(family = "play", size = 8, color = "black"),
  plot.title = element_text(family = "play", size = 20,
                            face = "bold", color="#171a21"),
  plot.subtitle = element_text(family = "play", size = 15, 
...
The data for the above analysis was obtained from the [Election Commission of India portal](https://eci.gov.in/) and [Trivedi Center for Political Data](https://tcpd.ashoka.edu.in/) at the Ashoka University, India.  The various reports and publications referenced below serve as a secondary source in the process of this analysis. The analysis covers each district of the West Bengal states represented in the map below and provides election results for each of the 294 assembly constituencies in West Bengal.
...
wb_total_percent%>% 
  ...
  labs(title = "Total number of votes secured by each political parties", 
       ...
       y = "Political parties") +
 theme(axis.text.x = element_text(colour = "grey20", size = 9, angle = 180, hjust = 0.5, vjust = 0.5))
...
TMC won 82% of the General or non-reserved (168 out of 206) seats, whereas it won 53% (36 out of 68) of the SC and 56 % of the ST (9 out of 16) reserved seats. TMC has done better electorally in General seats when compared to SC and ST seats.
BJP won 18% of the total General or non-reserved (18 out of 206) seats and 47% of the SC (32 out of 68) and 44 % of the ST (7 out of 16) reserved seats. The BJP has done better electorally in SC and ST seats when compared to the General seats.
...
wb %>% 
  ...
  mutate(party = fct_reorder(party, n)) %>% 
    ggplot(aes(n, party, fill = party)) + 
    geom_col(width = 0.3, show.legend = F) +
  geom_text_repel(aes(label = n), color = "black", vjust = 1, hjust = 0.5) +
...
## BANKURA District: Winners per constituency and top 3 candidates
...
## BARDHAMAN District: Winners per constituency and top 3 candidates
...
## BIRBHUM District: Winners per constituency and top 3 candidates
...
## COOCH BEHAR District: Winners per constituency and top 3 candidates
...
## DAKSHIN DINAJPUR District: Winners per constituency and top 3 candidates
...
## DARJEELING District: Winners per constituency and top 3 candidates
...
## HOOGHLY District: Winners per constituency and top 3 candidates
...
## HOWRAH District: Winners per constituency and top 3 candidates
...
## JALPAIGURI District: Winners per constituency and top 3 candidates
...
## KOLKATA CORPORATION District: Winners per constituency and top 3 candidates
...
## MALDAH District: Winners per constituency and top 3 candidates
...
## MURSHIDABAD District: Winners per constituency and top 3 candidates
...
## NADIA District: Winners per constituency and top 3 candidates
...
## NORTH 24 PARGANAS District: Winners per constituency and top 3 candidates
...
## PASCHIM MEDINIPUR District: Winners per constituency and top 3 candidates
...
## PURBA MEDINIPUR District: Winners per constituency and top 3 candidates
...
## PURULIA District: Winners per constituency and top 3 candidates
...
## SOUTH 24 PARGANAS District: Winners per constituency and top 3 candidates
...
## UTTAR DINAJPUR District: Winners per constituency and top 3 candidates
...
Chaturvedi, R. M. (2021, May 4). [*ET Analysis: How TMC beat BJP at its own game in West Bengal elections*. Economic Times.](https://m.economictimes.com/news/elections/assembly-elections/west-bengal/et-analysis-tmc-beat-bjp-at-its-own-game-turned-around-saffron-poll-planks-for-its-own-gains/amp_articleshow/82383821.cms)

Ghatak, M., & Maitra, P. (2021, May 12). [*2021 West Bengal Assembly election: Did the Covid-19 surge matter?* Ideas for India.](https://www.ideasforindia.in/topics/governance/2021-west-bengal-assembly-election-did-the-covid-19-surge-matter.html)

Tiwari, A. (2021, May 6). [*In Charts: How Mamata Banerjee Scripted A Record Win In West Bengal Copyright © BloombergQuint*.](https://www.bloombergquint.com/politics/how-mamata-banerjee-scripted-a-record-win-in-west-bengal-election-results-2021-in-charts)

Iyengar, P. (2021, May 7). [*Statistical Afternotes: TMC May Have Won Bengal, but BJP Did Not Do Badly*. The Wire.](https://thewire.in/politics/statistical-afternotes-tmc-may-have-won-bengal-but-bjp-did-not-do-badly)

Kishore, R., & Jha, A. (2021, May 4). [*WEST BENGAL ASSEMBLY ELECTION 3 crucial takeaways from Bengal results*. Hindustan Times.](https://www.hindustantimes.com/elections/west-bengal-assembly-election/3-crucial-takeaways-from-bengal-results-101620086556255.html)

Bhattacharya, A. (2021, May 3). [*Why did the BJP lose Bengal 2021?* India Today.](https://www.indiatoday.in/news-analysis/story/why-did-bjp-lose-bengal-elections-2021-1798260-2021-05-03)

Dasgupta, S. (2021, May 3). [*Lessons learnt The results of the West Bengal assembly elections deserve a close analysis*. The Telegraph.](https://www.telegraphindia.com/opinion/the-results-of-the-west-bengal-assembly-elections-deserve-a-close-analysis/cid/1815369)
